...
<a {if ! $itemInCart} class="hideme" {/if} id="removecart_{$rsProduct[0]['id']}" href="" onclick="remfromcart({$rsProduct[0]['id']}); return false;" alt="удалить из корзину">Удалить из корзины</a>
